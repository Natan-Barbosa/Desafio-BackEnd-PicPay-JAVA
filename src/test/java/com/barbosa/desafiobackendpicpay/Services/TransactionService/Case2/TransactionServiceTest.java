package com.barbosa.desafiobackendpicpay.Services.TransactionService.Case2;
...
class TransactionServiceTest {
    ...
    @Test
    @DisplayName("Should Throws IllegalTransactionException Because Sender Is Seller")
